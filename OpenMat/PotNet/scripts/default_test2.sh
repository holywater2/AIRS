...
CUDA_VISIBLE_DEVICES="0" CUBLAS_WORKSPACE_CONFIG=:16:8 python3 main.py --config /home/holywater2/2023/AIRS/OpenMat/PotNet/configs/potnet_test2.yaml --output_dir outputs/model_test2
